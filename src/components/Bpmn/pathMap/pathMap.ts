...
export default function PathMap(this: any) {
  /**
  ...
  this.pathMap = {
    ...
    TASK_TYPE_SCRIPT: {
      d: '',
      // d:
      //   'M17.5 15c0 1.381-1.119 2.5-2.5 2.5s-2.5-1.119-2.5-2.5c0-1.381 1.119-2.5 2.5-2.5s2.5 1.119 2.5 2.5z' +
      //   'M7.5 5c0 1.381-1.119 2.5-2.5 2.5s-2.5-1.119-2.5-2.5c0-1.381 1.119-2.5 2.5-2.5s2.5 1.119 2.5 2.5z' +
      //   'M5 17.5v-10c0 4.142 3.358 7.5 7.5 7.5v0',
    },
    TASK_TYPE_USER_1: {
      d: '',
      // d:
    ...
    TASK_TYPE_MANUAL: {
      ...
      // d:
      //   'M5 2.5v10' +
      //   'M17.5 5c0 1.381-1.119 2.5-2.5 2.5s-2.5-1.119-2.5-2.5c0-1.381 1.119-2.5 2.5-2.5s2.5 1.119 2.5 2.5z' +
      //   'M7.5 15c0 1.381-1.119 2.5-2.5 2.5s-2.5-1.119-2.5-2.5c0-1.381 1.119-2.5 2.5-2.5s2.5 1.119 2.5 2.5z' +
      //   'M15 7.5c0 4.142-3.358 7.5-7.5 7.5v0',
    },
    ...
    TASK_TYPE_BUSINESS_RULE_MAIN: {
      ...
      // d:
      //   'M22 12c0 5.523-4.477 10-10 10s-10-4.477-10-10c0-5.523 4.477-10 10-10s10 4.477 10 10z' +
      //   'M4.93 4.93l14.14 14.14',
      // d:
      //   'M {mx},{my} ' +
      //   'M7.921 17.5h-4.171c-0.69 0-1.25-0.56-1.25-1.25v-12.5c0-0.69 0.56-1.25 1.25-1.25h12.5c0.69 0 1.25 0.56 1.25 1.25v4.179' +
      //   'M17.5 12.098v4.986c0 0.23-0.187 0.417-0.417 0.417h-4.985' +
      //   'M17.5 12.098h-10' +
      //   'M9.583 9.583l-2.5 2.5 2.5 2.5',
      d: '',
    },
    MESSAGE_FLOW_MARKER: {
  ...
  this.getRawPath = function getRawPath(pathId: string) {
   ...
   *
   */
  this.getScaledPath = function getScaledPath(pathId: string, param: any) {
    ...
    var coordinates: any = {}; // map for the scaled coordinates
    if (param.position) {
      // path
...
function replacer(all: any, key: string, obj: any) {
  var res = obj;
